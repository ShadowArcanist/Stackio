...
<Steps>
  ...
  - On **Coolify** and click **“Edit Compose”**  
    ![Edit compose option on Coolify](/images/core/update-guide/edit-compose-option.webp)
  - Modify the compose file to include the new version and any necessary updates  
    ![Edit compose modal on Coolify](/images/core/update-guide/edit-compose-modal.webp)  
  - Update the environment variables if needed:
    ![Environment Variables page on Coolify dashboard](/images/core/update-guide/application-environment-variables.webp)  
      <Callout title="Tip" type="tip">
