...
<Steps>
  <Step>
    ...
    ![Resource page on Coolify](/images/core/application-deploy-guide/resources-page.webp)
  </Step>
  ...
  <Step>
    ...
    ![New Resource page on Coolify](/images/core/application-deploy-guide/new-resource-page.webp)
  </Step>
  ...
  <Step>
    ...
    ![Server selector page on Coolify](/images/core/application-deploy-guide/server-selector.webp)
  ...
  <Step>
    ...
    ![Docker compose empty input area on Coolify](/images/core/application-deploy-guide/docker-compose-empty-input.webp)
  ...
  <Step>
    ...
    ![Service configuration page on Coolify](/images/core/application-deploy-guide/service-configuration-page.webp)
